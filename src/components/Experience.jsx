...
function Experience() {
  const timelineData = [
    ...
    // 工作經歷
    {
      title: "廣達電腦股份有限公司 / 工業設計工程師",
      period: "2025/09 ~ Now",
      group: "work",
      description:
        "參與國際品牌以及白牌筆記型電腦產品設計與開發，執行產品外觀設計、Creo 3D CAD 建模與設計提案，並參與 RFI/RFQ 階段之概念發展、CAD Report 與設計資料製作。專案開發期間負責 CMF 與零件色彩管理，包含色樣確認、九宮格比對、供應商打樣溝通及客戶承認流程，並追蹤 PV／MV／MP 各階段樣品與零件狀態。透過與客戶、PM、機構工程師及供應商跨部門協作，累積從前期設計提案、工程開發至量產導入的完整產品開發經驗。",
    },
    {
